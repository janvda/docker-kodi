...
RUN mkdir /add-ons && \
   ...
   wget https://github.com/add-ons/plugin.video.vrt.nu/releases/download/v2.5.37/plugin.video.vrt.nu-2.5.37+matrix.1.zip -O /add-ons/plugin.video.vrt.nu-2.5.37+matrix.1.zip
